...
# Streamlit 제목
st.title("The Mindful Companion 💬")
...
if "chat_model" not in st.session_state:
    st.session_state["chat_model"] = ChatOpenAI(
        api_key=api_key, model_name="gpt-4o", temperature=0.6, streaming=True
    )

# 프롬프트 파일 로드
prompt_path = "mindful_companion2.yaml"
...
if user_input:
    ...
    chat_history_str = st.session_state["memory"].chat_memory.messages
